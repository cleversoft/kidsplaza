 ...
 */
  ...
  */
	...
	// Widget interface hack for posts sidebar widget/block
	$widgetInterface = dirname(dirname($basePath)) . DS . 'Widget' . DS . 'Block' . DS . 'Interface.php';
	
	if (!is_file($widgetInterface)) {
		interface Mage_Widget_Block_Interface {}
	}

	// Top menu block
	$topMenuBlock = dirname(dirname($basePath)) . DS . 'Page' . DS . 'Block' . DS . 'Html' . DS . 'Topmenu.php';
	
	if (!is_file($topMenuBlock)) {
