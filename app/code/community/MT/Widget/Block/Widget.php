...
class MT_Widget_Block_Widget extends Mage_Catalog_Block_Product_Abstract implements Mage_Widget_Block_Interface {
    ...
    public function getCacheKeyInfo(){
        return array(
            ...
            is_array($this->getData('category_ids')) ? implode(',', $this->getData('category_ids')) : $this->getData('category_ids'),
            $this->getData('mode'),
            $this->getData('product_ids'),
            $this->getData('attribute'),
            is_array($this->getData('attribute_options')) ? implode(',', $this->getData('attribute_options')) : $this->getData('attribute_options'),
