 ...
 *
 */
class MT_Review_Model_Resource_Review_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     * Review table
     *
     ...
     * @var string
     */
    protected $_reviewHelpfulnessTable;
    ...
    protected function _construct()
    {
        ...
        $this->_ratingTableName     = $this->getTable('rating/rating_option_vote');
