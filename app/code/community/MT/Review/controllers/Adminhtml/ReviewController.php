 ...
 *
 */
class MT_Review_Adminhtml_ReviewController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function indexAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('mtreview/adminhtml_review_main'));
    ...
    public function editAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('mtreview/adminhtml_review_edit'));
    ...
    public function newAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('mtreview/adminhtml_review_add'));
        $this->_addContent($this->getLayout()->createBlock('mtreview/adminhtml_review_product_grid'));
    ...
    {
        $this->getResponse()->setBody($this->getLayout()->createBlock('mtreview/adminhtml_review_product_grid')->toHtml());
    }

    public function reviewGridAction()
    {
        $this->getResponse()->setBody($this->getLayout()->createBlock('mtreview/adminhtml_review_grid')->toHtml());
    }
