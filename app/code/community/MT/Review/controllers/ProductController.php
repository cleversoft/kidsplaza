 ...
 *
 */
class MT_Review_ProductController extends Mage_Core_Controller_Front_Action
{
    ...
    {
        parent::preDispatch();
        $allowGuest = Mage::helper('mtreview')->confAllowOnlyLogged();
        ...
        if (!$allowGuest && $action == 'post' && $this->getRequest()->isPost()) {
            if (!Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::getSingleton('mtreview/session')->setFormData($this->getRequest()->getPost())
    ...
    public function postAction()
    {
        ...
        if ($data = Mage::getSingleton('mtreview/session')->getFormData(true)) {
            $rating = array();
        ...
        if ($redirectUrl = Mage::getSingleton('mtreview/session')->getRedirectUrl(true)) {
    ...
    public function viewAction()
    {
        ...
        $this->loadLayout();
        $this->_initLayoutMessages('mtreview/session');
